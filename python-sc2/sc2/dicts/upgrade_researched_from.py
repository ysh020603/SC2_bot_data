...
UPGRADE_RESEARCHED_FROM: dict[UpgradeId, UnitTypeId] = {
    ...
    UpgradeId.MEDIVACRAPIDDEPLOYMENT: UnitTypeId.STARPORTTECHLAB,
    UpgradeId.DURABLEMATERIALS: UnitTypeId.STARPORTTECHLAB,
    UpgradeId.CYCLONELOCKONRANGEUPGRADE: UnitTypeId.FACTORYTECHLAB,
    UpgradeId.CYCLONERAPIDFIRELAUNCHERS: UnitTypeId.FACTORYTECHLAB,
    UpgradeId.ARMORPIERCINGROCKETS: UnitTypeId.FACTORYTECHLAB,
    UpgradeId.TRANSFORMATIONSERVOS: UnitTypeId.FACTORYTECHLAB,
    UpgradeId.NEOSTEELFRAME: UnitTypeId.ENGINEERINGBAY,
    UpgradeId.TERRANSHIPARMORSLEVEL1: UnitTypeId.ARMORY,
    UpgradeId.TERRANSHIPARMORSLEVEL2: UnitTypeId.ARMORY,
    UpgradeId.TERRANSHIPARMORSLEVEL3: UnitTypeId.ARMORY,
