...
实现目标：提供一套与种族强相关、但与具体战术意图无关的兜底 ``SequentialList``，
...
from sharpy.plans.require import UnitExists, Time
...
class GenericTerranTactics(SequentialList):
    """种族通用兜底战术：与具体策略名无关，可被新生成策略直接复用。"""
