...
* High-Priority Yamato Research:
As soon as a Battlecruiser exists or begins production, immediately research Yamato Cannon from the Fusion Core with the highest possible priority. Never delay this research for additional units, upgrades, or production unless the Fusion Core is unavailable.
