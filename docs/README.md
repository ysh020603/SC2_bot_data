...
本目录记录环境配置、bot 运行、轨迹采集、v8 step 标注、SFT 数据构造和仓库管理。当前主线目标是：用本仓库采集胜局轨迹，并构造与 `SC2-Agent-260510` 三个 LLM 位置对齐的训练数据。
...
4. [sft_pipeline_usage.md](sft_pipeline_usage.md)：采集轨迹 -> v8 step -> SFT 的完整流程。
