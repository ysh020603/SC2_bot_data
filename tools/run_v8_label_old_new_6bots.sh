#!/usr/bin/env bash
# OLD + NEW 各 6 个 Terran 策略采集结果的 v8 step 标注（Kimi nothinking）。
# 用法:
#   bash tools/run_v8_label_old_new_6bots.sh
...
SESSION="${TMUX_SESSION:-sc2_v8_label_old_new_6bots_20260706}"
...
OLD_DATA="bo_collection_runs/2026-07-06_terran_old6bots_3maps_macro"
NEW_DATA="bo_collection_runs/2026-07-06_terran_new6bots_3maps_macro"
OLD_OUTPUT="sft_pipeline_outputs/2026-07-06_terran_old6bots_3maps_macro/v8_steps"
NEW_OUTPUT="sft_pipeline_outputs/2026-07-06_terran_new6bots_3maps_macro/v8_steps"
MASTER_LOG="${ROOT}/sft_pipeline_outputs/2026-07-06_v8_label_old_new_6bots/master_run.log"
...
echo \"========== v8 OLD+NEW 6bots label start \$(date -Iseconds) ==========\" && \
...
echo "已在 tmux 后台启动 v8 标注（先 OLD 后 NEW）"
