"""Resource-free tool package for the cyclones strategy."""
...
class CyclonesStrategyTools(BuildOrder):
    """Cyclone strategy tools that do not spend minerals, gas, or supply."""
