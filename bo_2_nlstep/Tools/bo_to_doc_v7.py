"""
BO Action Sequence -> Natural Language Build Order Document (No Ordinals v7)
...
Usage:
    python bo_to_doc_v7.py                    # process all 10 BOs (5 concurrent)
    python bo_to_doc_v7.py --bot banshees     # single BO
    python bo_to_doc_v7.py --max-workers 3    # 3 concurrent
    python bo_to_doc_v7.py --bot banshees --model-key kimi-k2.5
"""
...
from prompt_template_v7 import (
    SYSTEM_PROMPT,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="BO Action Sequence -> Natural Language Docs (v7 No Ordinals)")
    ...
    parser.add_argument("--output-dir", type=str,
                        default=None,
                        help="Output directory for bo_docs (default: Tools/bo_docs_no_ordinals)")
    ...
    output_dir = args.output_dir or os.path.join(_TOOLS_DIR, "bo_docs_no_ordinals")
