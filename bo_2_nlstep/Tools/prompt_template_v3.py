...
into natural language build order step descriptions (Slang v3).

Based on v1, with two changes:
- No cross-step context (BuildContext removed)
...
# ---------------------------------------------------------------------------
# User prompt template -- no cross-step context
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Summary prompt -- unchanged from v1 with slang note
# ---------------------------------------------------------------------------
...
Use SC2 Terran community slang and abbreviations naturally throughout the summary.
...
Write a one-paragraph English summary of this build order. Use SC2 Terran community slang (e.g. depot/rax/CC/orbital/OC, worker, tank, BC, stim, etc.)."""
